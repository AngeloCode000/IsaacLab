...
"""Script to play a checkpoint with RSL-RL while driving the command via keyboard."""
...
parser = argparse.ArgumentParser(description="Play an RSL-RL agent with keyboard velocity commands.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    """Play with RSL-RL agent driven by keyboard velocity commands."""
